...
api('vault',     VaultJsonTemplate)
api('labeledmulti',  LabeledMultiJsonTemplate)
api('tippr',        TipprJsonTemplate)
...
api('Vaulttraffic', TrafficJsonTemplate)
...
api('Vaultstylesheet', StylesheetTemplate)
api('Vaultstylesheetsource', StylesheetTemplate)
api('createVault', VaultSettingsTemplate)
