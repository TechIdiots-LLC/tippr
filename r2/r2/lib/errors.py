...
error_list = dict((
        ...
        ('VAULT_EXISTS', _('that vault already exists')),
        ('VAULT_NOEXIST', _('that vault doesn\'t exist')),
        ('VAULT_NOTALLOWED', _("you aren't allowed to post there.")),
        ('VAULT_NO_ACCESS', _("you aren't allowed access to this vault")),
        ('VAULT_REQUIRED', _('you must specify a vault')),
        ('VAULT_DISABLED_ADS', _('this vault has chosen to disable their ads at this time')),
        ('BAD_VAULT_NAME', _('that name isn\'t going to work')),
        ...
        ('VAULT_RATELIMIT', _("you are doing that too much. try again later.")),
        ...
        ('MULTI_TOO_MANY_VAULTS', _('no more space for vaults in that multivault')),
        ('MULTI_SPECIAL_Vault', _("can't add special vault %(path)s")),
        ('TOO_MANY_VAULTS', _('maximum %(max)s vaults')),
        ...
        ('GOLD_ONLY_VAULT_REQUIRED', _("this vault must be 'gold only' to select this")),
        ('CANT_CREATE_VAULT', _("your account is too new or you do not have enough karma to create a vault. please contact the admins to request an exemption.")),
        ...
        ('MUTED_FROM_VAULT', _("This user has been muted from the vault.")),
        ('COMMENT_NOT_STICKYABLE', _("This comment is not stickyable. Ensure that it is a top level comment.")),
        ('VAULT_RULE_EXISTS', _("A vault rule by that name already exists.")),
        ('VAULT_RULE_DOESNT_EXIST', _("No vault rule by that name exists.")),
        ('VAULT_RULE_TOO_MANY', _("This vault already has the maximum number of rules.")),
