...
class Globals:
    spec = {
        ...
        ConfigValue.int: [
            ...
            'vault_banned_quota',
            'vault_muted_quota',
            'vault_wikibanned_quota',
            'vault_wikicontributor_quota',
            'vault_moderator_invite_quota',
            'vault_contributor_quota',
            'vault_quota_time',
            'vault_invite_limit',
    ...
    live_config_spec = {
        ...
        ConfigValue.int: [
            ...
            'create_vault_account_age_days',
            'create_vault_comment_karma',
            'create_vault_link_karma',
            'cflag_min_votes',
