...
class Email:
    ...
    subjects = {
        Kind.SHARE : _("[tippr] %(user)s has shared a link with you"),
        Kind.FEEDBACK : _("[feedback] feedback from '%(user)s'"),
        Kind.ADVERTISE :  _("[advertising] feedback from '%(user)s'"),
        Kind.OPTOUT : _("[tippr] email removal notice"),
        Kind.OPTIN  : _("[tippr] email addition notice"),
        Kind.RESET_PASSWORD : _("[tippr] reset your password"),
        Kind.VERIFY_EMAIL : _("[tippr] verify your email address"),
        Kind.BID_PROMO : _("[tippr] your budget has been accepted"),
        Kind.ACCEPT_PROMO : _("[tippr] your promotion has been accepted"),
        Kind.REJECT_PROMO : _("[tippr] your promotion has been rejected"),
        Kind.QUEUED_PROMO : _("[tippr] your promotion has been charged"),
        Kind.LIVE_PROMO   : _("[tippr] your promotion is now live"),
        Kind.FINISHED_PROMO : _("[tippr] your promotion has finished"),
        Kind.NEW_PROMO : _("[tippr] your promotion has been created"),
        Kind.EDITED_LIVE_PROMO : _("[tippr] your promotion edit is being approved"),
        Kind.NERDMAIL : _("[tippr] hey, nerd!"),
        Kind.GOLDMAIL : _("[tippr] tippr gold activation link"),
        Kind.PASSWORD_CHANGE : _("[tippr] your password has been changed"),
        Kind.EMAIL_CHANGE : _("[tippr] your email address has been changed"),
        Kind.REFUNDED_PROMO: _("[tippr] your campaign didn't get enough impressions"),
        Kind.VOID_PAYMENT: _("[tippr] your payment has been voided"),
        Kind.GOLD_GIFT_CODE: _("[tippr] your tippr gold gift code"),
        ...
        Kind.MESSAGE_NOTIFICATION: _("[tippr] message notification"),
        Kind.ADS_ALERT: _("[tippr] Ads Alert"),
        }
